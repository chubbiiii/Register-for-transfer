...
?>
<form action="save_editsubjects.php" name="frmAdd" method="post">
...
<tr>
  ...
  <tr>
    ...
    <td><input type="text" name="subjects_name" size="50" id="subjects_name" value="<?php echo $result["subjects_name"];?>"></td>
    </tr>
  <tr>
    <th width="120">รหัสวิชา</th>
    <td><input type="text" name="subjects_id" size="20" id="subjects_id" value="<?php echo $result["subjects_id"];?>"></td>
    </tr>
  <tr>
