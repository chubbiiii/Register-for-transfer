...
&nbsp;&nbsp;<a href="\www\admin\user\report_user.php"><input type="button" value="สรุปการลงทะเบียน" class="btn"></a>
<a href="\www\admin\admin_page.php"><input type="button" value="กลับหน้า Admin" class="btn"></a>
...
?>
    ...
    <td align="center"><a href="addsubjectsregisters.php?subjects_no=<?php echo $result["subjects_no"];?>"><input type="button" value="ลงทะเบียน" class="btn"></a>
    </tr>
    <?php
$i++;
}
